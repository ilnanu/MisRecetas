...
class DetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.backgroundColor = UIColor(red: 0.9, green: 0.90, blue: 0.9, alpha: 0.25)
        self.tableView.tableFooterView = UIView(frame: CGRect.zero)
        self.tableView.separatorColor = UIColor(red: 0.9, green: 0.90, blue: 0.9, alpha: 0.75)
